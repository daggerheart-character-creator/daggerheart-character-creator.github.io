...
export const CLASS_DETAILS: Record<string, ClassDetail> = {
    ...
    Rogue: {
        ...
        classFeature: {
            name: "Cloaked & Sneak Attack",
            description: `Any time you would be Hidden, you are instead Cloaked. While Cloaked, you remain unseen if stationary. Sneak Attack: When you succeed on an attack while Cloaked or with an ally in Melee range, add a number of d6s equal to your tier to your damage roll.`
        },
        startingEvasion: 12,
        startingHP: 6,
        hopeFeature: {
    ...
    Sorcerer: {
        ...
        classFeature: {
            name: "Arcane Sense, Minor Illusion, Channel Raw Power",
            description: `Arcane Sense: Sense magical people and objects within Close range. Minor Illusion: Create a minor visual illusion within Close range. Channel Raw Power: Once per long rest, place a domain card from your loadout into your vault to gain Hope or enhance a spell’s damage.`
        },
        startingEvasion: 10,
        startingHP: 6,
        hopeFeature: {
    ...
    Warrior: {
        ...
        classFeature: {
            name: "Battle Ritual, Courage",
            description: `Battle Ritual: Once per long rest, before attempting something dangerous, clear 2 Stress and gain 2 Hope. Courage: When you fail a roll with Fear, you gain a Hope.`
        },
        startingEvasion: 11,
        startingHP: 6,
        hopeFeature: {
    ...
    Wizard: {
        ...
        classFeature: {
            name: "Prepared, Adept",
            description: `Prepared: Take an additional domain card of your level or lower from a domain you have access to. Adept: When you Utilize an Experience, you can mark a Stress instead of spending a Hope. If you do, double your Experience modifier for that roll.`
        },
        startingEvasion: 10,
        startingHP: 5,
        hopeFeature: {
